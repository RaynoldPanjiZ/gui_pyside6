...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.edit_text.setStyleSheet(u"")
        ...
        self.num_frame = QFrame(Form)
        self.num_frame.setObjectName(u"num_frame")
        self.num_frame.setFrameShape(QFrame.StyledPanel)
        self.num_frame.setFrameShadow(QFrame.Raised)
        self.horizontalLayout = QHBoxLayout(self.num_frame)
        self.horizontalLayout.setSpacing(10)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalSpacer_11 = QSpacerItem(5, 30, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)
        ...
        self.btn_1 = QPushButton(self.num_frame)
...
" }")
        ...
        self.btn_2 = QPushButton(self.num_frame)
...
" }")
        ...
        self.btn_3 = QPushButton(self.num_frame)
...
" }")
        ...
        self.btn_4 = QPushButton(self.num_frame)
...
" }")
        ...
        self.btn_5 = QPushButton(self.num_frame)
...
" }")
        ...
        self.btn_6 = QPushButton(self.num_frame)
...
" }")
        ...
        self.btn_7 = QPushButton(self.num_frame)
...
" }")
        ...
        self.btn_8 = QPushButton(self.num_frame)
...
" }")
        ...
        self.btn_9 = QPushButton(self.num_frame)
...
" }")
        ...
        self.btn_0 = QPushButton(self.num_frame)
...
" }")
        ...
        self.horizontalLayout.addLayout(self.num_layout)

        self.horizontalSpacer_12 = QSpacerItem(5, 30, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)
...
" }")
        ...
        self.btn_a = QPushButton(self.frame)
...
" }")
        ...
        self.btn_s = QPushButton(self.frame)
...
" }")
        ...
        self.btn_d = QPushButton(self.frame)
...
" }")
        ...
        self.btn_f = QPushButton(self.frame)
...
" }")
        ...
        self.btn_g = QPushButton(self.frame)
...
" }")
        ...
        self.btn_h = QPushButton(self.frame)
...
" }")
        ...
        self.btn_j = QPushButton(self.frame)
...
" }")
        ...
        self.btn_k = QPushButton(self.frame)
...
" }")
        ...
        self.btn_l = QPushButton(self.frame)
...
" }")
        ...
        self.horizontalLayout_2.addLayout(self.alpha_layout_2)
        ...
        self.btn_z = QPushButton(self.frame_2)
...
" }")
        ...
        self.btn_x = QPushButton(self.frame_2)
...
" }")
        ...
        self.btn_c = QPushButton(self.frame_2)
...
" }")
        ...
        self.btn_v = QPushButton(self.frame_2)
...
" }")
        ...
        self.btn_b = QPushButton(self.frame_2)
...
" }")
        ...
        self.btn_n = QPushButton(self.frame_2)
...
" }")
        ...
        self.alpha_layout_3.setStretch(0, 10)
...
"")
    ...
    def retranslateUi(self, Form):
        ...
        self.btn_upper.setText(QCoreApplication.translate("Form", u"CapsLk", None))
        ...
        self.btn_ok.setText(QCoreApplication.translate("Form", u"ENTER", None))
    # retranslateUi
