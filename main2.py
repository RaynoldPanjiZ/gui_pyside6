...
class MainWindow(PySide6.QtWidgets.QMainWindow):
    def __init__(self, w):
        ...
        self.w.label_3.setPixmap(PySide6.QtGui.QPixmap(u"ui/icon/aery_rm.png"))
        self.w.screen_lock_btn.setIcon(PySide6.QtGui.QIcon(u"ui/icon/lock (1).png"))
        self.w.btn_screen1x.setIcon(PySide6.QtGui.QIcon(u"ui/icon/grid1_.png"))
        self.w.btn_screen4x.setIcon(PySide6.QtGui.QIcon(u"ui/icon/grid4_.png"))
        self.w.btn_screen9x.setIcon(PySide6.QtGui.QIcon(u"ui/icon/grid9_.png"))
        self.w.fullscreen_ch_btn.setIcon(PySide6.QtGui.QIcon(u"ui/icon/fullscreen1.png"))
        ...
        self.screen0.setMinimumSize(PySide6.QtCore.QSize(self.screen0.width(), self.screen0.height()))
    ...
    def screen_keyboard(self):
        ...
        if UtilsVariables.keyboard_active:
            if self.key_widget is None:
                ...
                ui_file = PySide6.QtCore.QFile("ui/admgui/all_ui/keyboard.ui")
    ...
    def delete_camera_dialog(self):
        ...
        dlg.addButton('Confirm', PySide6.QtWidgets.QMessageBox.YesRole)
        dlg.addButton(PySide6.QtWidgets.QMessageBox.Cancel)
        with open("ui/style/style_form.qss", "r") as file:
            dlg.setStyleSheet(file.read())
        button = dlg.exec()

        if button == PySide6.QtWidgets.QMessageBox.Cancel:
            print("No!")
        else:
            print("Yes!")
    ...
    def spliScreen(self, event):
        ...
        if event == 0:
            ...
            self.screen0.setMinimumSize(PySide6.QtCore.QSize(self.screen0.width(), self.screen0.height()))
            self.screen0.setMaximumSize(PySide6.QtCore.QSize(self.screen0.width(), self.screen0.height()))
            
            self.screen1_available = True
            self.screen1 = self.w.chscreen_1_01
            self.screen1.setMinimumSize(PySide6.QtCore.QSize(self.screen1.width(), self.screen1.height()))
            self.screen1.setMaximumSize(PySide6.QtCore.QSize(self.screen1.width(), self.screen1.height()))
            
            self.screen2_available = True
            self.screen2 = self.w.chscreen_1_10
            self.screen2.setMinimumSize(PySide6.QtCore.QSize(self.screen2.width(), self.screen2.height()))
            self.screen2.setMaximumSize(PySide6.QtCore.QSize(self.screen2.width(), self.screen2.height()))
            
            self.screen3_available = True
            self.screen3 = self.w.chscreen_1_11
            self.screen3.setMinimumSize(PySide6.QtCore.QSize(self.screen3.width(), self.screen3.height()))
            self.screen3.setMaximumSize(PySide6.QtCore.QSize(self.screen3.width(), self.screen3.height()))
            ...
            self.screen4.setMinimumSize(PySide6.QtCore.QSize(self.screen4.width(), self.screen4.height()))
            self.screen4.setMaximumSize(PySide6.QtCore.QSize(self.screen4.width(), self.screen4.height()))
        elif event == 3:
    ...
    def exit_button(self):
        PySide6.QtWidgets.QApplication.instance().quit()
...
if __name__ == "__main__":
    ...
    ui_file = PySide6.QtCore.QFile("ui/admgui/all_ui/mainwindow.ui")
    if not ui_file.open(PySide6.QtCore.QIODevice.ReadOnly):
        print(f"Cannot open UI file: {ui_file.errorString()}")
        sys.exit(-1)
